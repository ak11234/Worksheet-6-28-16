...
public class SmartTicTacToe {
    ...
    public static int getComputerMove(String[] board, int player) {
        ...
        /*
        Check the 0 square (upper left corner)

        If the 0 square is empty,
        Check if the 1 and 2 squares have my pieces in them.
        If so, 0 is a good move to make!

        Check if the 3 and 6 squares have my pieces in them.
        If so, 0 is a good move to make!

        Check if the 4 and 8 squares have my pieces in them.
        If so, 0 is a good move to make!
        */
        if (board[0].equals("*")) {
            if (board[1].equals(myValue) && board[2].equals(myValue)) {
                return 0;
            }
            if (board[3].equals(myValue) && board[6].equals(myValue)) {
                return 0;
            }
